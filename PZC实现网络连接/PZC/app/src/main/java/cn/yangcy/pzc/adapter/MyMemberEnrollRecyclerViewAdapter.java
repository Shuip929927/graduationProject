...
public class MyMemberEnrollRecyclerViewAdapter
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        if ("activities".equals(type)) {
            ...
            if(NetWorkUtil.isConnected(ActivitiesEnrollPage.INSTANCE.getContext())){
                mViewModel.getDepartmentLiveByIdNet(user.getDepartmentId()).observe(ActivitiesEnrollPage.INSTANCE,
                        new Observer<Department>() {
                            @Override
                            public void onChanged(Department department) {
                                departmentInfo = department.getDepartment_name();

                            }
                        });
                mViewModel.getMajorLiveByIdNet(user.getMajorId()).observe(ActivitiesEnrollPage.INSTANCE,
                        new Observer<Major>() {
                            @Override
                            public void onChanged(Major major) {
                                majorInfo = major.getMajor_name();
                ...
                aeLive = mViewModel.getActivitiesEnrollByUserAccountAndActivitiesIdNet
           ...
           if(NetWorkUtil.isConnected(OrganizationEnrollPage.INSTANCE.getContext())){
               mViewModel.getDepartmentLiveByIdNet(user.getDepartmentId()).observe(OrganizationEnrollPage.INSTANCE,
                       new Observer<Department>() {
                           @Override
                           public void onChanged(Department department) {
                               departmentInfo = department.getDepartment_name();
               ...
               mViewModel.getMajorLiveByIdNet(user.getMajorId()).observe(OrganizationEnrollPage.INSTANCE,
                       new Observer<Major>() {
                           @Override
                           public void onChanged(Major major) {
                               majorInfo = major.getMajor_name();
               ...
               oeLive = mViewModel.getOrganizationEnrollLiveNet(user.getAccount(), mViewModel.getOrganizationId());
           } else {
                ...
                if ("activities".equals(type)) {
                    ...
                    aeLive.observe(ActivitiesEnrollPage.INSTANCE, new Observer<ActivitiesEnroll>() {
                        ...
                        public void onChanged(ActivitiesEnroll activitiesEnroll) {
                            ...
                            activitiesEnroll.setActivity_enroll_state(2);

                            if(NetWorkUtil.isConnected(ActivitiesEnrollPage.INSTANCE.getContext())){
                                mViewModel.updateAENet(activitiesEnroll);
                            } else {
                    ...
                    oeLive.observe(OrganizationEnrollPage.INSTANCE, new Observer<OrganizationEnroll>() {
                        ...
                        public void onChanged(OrganizationEnroll organizationEnroll) {
                            ...
                            organizationEnroll.setOrganization_enroll_state(2);
                            user.setPower(2);
                            if(NetWorkUtil.isConnected(OrganizationEnrollPage.INSTANCE.getContext())){
                                mViewModel.updateOENet(organizationEnroll);
                                mViewModel.updateUserNet(user);
                            } else {
                    ...
                    final LiveData<Organization> organizationLiveData;
                    if(NetWorkUtil.isConnected(OrganizationEnrollPage.INSTANCE.getContext())){
                        organizationLiveData = mViewModel.getOrganizationLiveByIdNet(mViewModel.getOrganizationId());
                    } else {
                        organizationLiveData = mViewModel.getOrganizationLiveById(mViewModel.getOrganizationId());
                    }
                    organizationLiveData.observe(
                            OrganizationEnrollPage.INSTANCE, new Observer<Organization>() {
                                ...
                                public void onChanged(Organization organization) {
                                    int num = organization.getNumber_of_people();
                                    organization.setNumber_of_people(num + 1);
                                    Log.i(TAG, "部门人数增加++ " + organization.getNumber_of_people());

                                    if(NetWorkUtil.isConnected(OrganizationEnrollPage.INSTANCE.getContext())){
                                        mViewModel.updateOrganizationNet(organization);
                                    } else {
                ...
                if ("activities".equals(type)) {
                    aeLive.observe(ActivitiesEnrollPage.INSTANCE, new Observer<ActivitiesEnroll>() {
                        ...
                        public void onChanged(ActivitiesEnroll activitiesEnroll) {
                            ...
                            activitiesEnroll.setActivity_enroll_state(0);
                    ...
                    oeLive.observe(OrganizationEnrollPage.INSTANCE, new Observer<OrganizationEnroll>() {
                        ...
                        public void onChanged(OrganizationEnroll organizationEnroll) {
                            Log.i(TAG, "onClick: OK " + organizationEnroll.toString());
                            organizationEnroll.setOrganization_enroll_state(0);
