...
public class StudentUnionListPageActivities extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        mAdapter = new MyActivitiesRecyclerViewAdapter("mStuA_Page",mViewModel);
    ...
    public void onResume() {
        super.onResume();
        LiveData<List<Activities>> allActivitiesLive;
        if(NetWorkUtil.isConnected(getContext())){
            allActivitiesLive = mViewModel.getAllActivitiesListLiveNet();
        } else {
