...
public class StudentUnionListPageOrganization extends Fragment {
    ...
    public void onResume() {
        super.onResume();
        LiveData<List<Organization>> organizationListLive;
        if(NetWorkUtil.isConnected(getContext())){
            organizationListLive = mViewModel.getAllOrganizationListLiveNet();
        } else {
            organizationListLive = mViewModel.getAllOrganizationListLive();
        }
