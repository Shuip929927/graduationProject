...
public class User implements Serializable {
    ...
    @Ignore
    public User(int account, String password, String name,int gender ,String phoneNumber, int departmentId, int majorId, String classes) {
    ...
    public User(int account, String password, String name, int gender,String phoneNumber, int departmentId, int majorId, String classes, int power) {
        this.account = account;
        this.password = password;
        this.name = name;
        this.gender = gender;
