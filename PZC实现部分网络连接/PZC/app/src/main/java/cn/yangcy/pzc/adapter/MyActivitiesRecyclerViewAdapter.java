...
//        return null;
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, int position) {
        ...
        if("mStuA_Page".equals(type)){
            ...
            myPageViewModel.getOrganizationLiveById(activities.getOrganizationId())
                    .observe(MyHoldActivitiesPage.INSTANCE, new Observer<Organization>() {
                        @Override
                        public void onChanged(Organization organization) {
                            holder.tv_holdOrganization.setText(infoHoldOrganization +" "+organization.getOrganization());
                        }
            ...
            myPageViewModel.getOrganizationLiveById(activities.getOrganizationId())
                    .observe(MyEnrollActivitiesPage.INSTANCE, new Observer<Organization>() {
                        @Override
                        public void onChanged(Organization organization) {
                            holder.tv_holdOrganization.setText(infoHoldOrganization + " " + organization.getOrganization());
                        }
