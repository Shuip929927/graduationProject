insert into DB_PZC.tb_admin(account,password,name) values('admin','admin','admin');


insert into DB_PZC.tb_department(department_name) values('材料工程系');
insert into DB_PZC.tb_department(department_name) values('传播与艺术系');
insert into DB_PZC.tb_department(department_name) values('电气工程系');
insert into DB_PZC.tb_department(department_name) values('化学工程系');
insert into DB_PZC.tb_department(department_name) values('环境资源工程系');
insert into DB_PZC.tb_department(department_name) values('机械工程系');
insert into DB_PZC.tb_department(department_name) values('计算机工程系');
insert into DB_PZC.tb_department(department_name) values('建筑系');
insert into DB_PZC.tb_department(department_name) values('经济管理系');
insert into DB_PZC.tb_department(department_name) values('人文艺术系');
insert into DB_PZC.tb_department(department_name) values('实验班');
insert into DB_PZC.tb_department(department_name) values('食品与生物工程系');
insert into DB_PZC.tb_department(department_name) values('土木工程系');
insert into DB_PZC.tb_department(department_name) values('外国语系');
insert into DB_PZC.tb_department(department_name) values('信息工程系');


insert into DB_PZC.tb_major(department_id,major_name) values('1','材料成型及控制工程');   
insert into DB_PZC.tb_major(department_id,major_name) values('1','材料科学与工程'); 
insert into DB_PZC.tb_major(department_id,major_name) values('2','表演');
insert into DB_PZC.tb_major(department_id,major_name) values('2','产品设计');
insert into DB_PZC.tb_major(department_id,major_name) values('2','工业设计');
insert into DB_PZC.tb_major(department_id,major_name) values('2','网络与新媒体');
insert into DB_PZC.tb_major(department_id,major_name) values('3','电气工程及其自动化');
insert into DB_PZC.tb_major(department_id,major_name) values('3','自动化');
insert into DB_PZC.tb_major(department_id,major_name) values('4','过程装备与控制工程');
insert into DB_PZC.tb_major(department_id,major_name) values('4','化学工程与工艺');
insert into DB_PZC.tb_major(department_id,major_name) values('4','应用化学');
insert into DB_PZC.tb_major(department_id,major_name) values('5','安全工程');
insert into DB_PZC.tb_major(department_id,major_name) values('5','环境工程');
insert into DB_PZC.tb_major(department_id,major_name) values('6','车辆工程');
insert into DB_PZC.tb_major(department_id,major_name) values('6','机械设计制造及其自动化');
insert into DB_PZC.tb_major(department_id,major_name) values('7','计算机科学与技术');
insert into DB_PZC.tb_major(department_id,major_name) values('7','软件工程');
insert into DB_PZC.tb_major(department_id,major_name) values('7','数字媒体技术');
insert into DB_PZC.tb_major(department_id,major_name) values('8','建筑学');
insert into DB_PZC.tb_major(department_id,major_name) values('9','财务管理');
insert into DB_PZC.tb_major(department_id,major_name) values('9','工业工程');
insert into DB_PZC.tb_major(department_id,major_name) values('9','国际经济与贸易');
insert into DB_PZC.tb_major(department_id,major_name) values('9','金融工程');
insert into DB_PZC.tb_major(department_id,major_name) values('9','物流管理');
insert into DB_PZC.tb_major(department_id,major_name) values('10','汉语言文学');
insert into DB_PZC.tb_major(department_id,major_name) values('10','音乐学');
insert into DB_PZC.tb_major(department_id,major_name) values('11','互联网金融与大数据技术综合实验班');
insert into DB_PZC.tb_major(department_id,major_name) values('11','智能技术及应用实验班');
insert into DB_PZC.tb_major(department_id,major_name) values('12','生物工程');
insert into DB_PZC.tb_major(department_id,major_name) values('12','食品科学与工程');
insert into DB_PZC.tb_major(department_id,major_name) values('13','土木工程');
insert into DB_PZC.tb_major(department_id,major_name) values('14','日语');
insert into DB_PZC.tb_major(department_id,major_name) values('14','英语');
insert into DB_PZC.tb_major(department_id,major_name) values('15','电子信息工程');
insert into DB_PZC.tb_major(department_id,major_name) values('15','通信工程');     



insert into DB_PZC.tb_user values('1234','81dc9bdb52d04dc20036dbd8313ed055','1','test','81dc9bdb52d04dc20036dbd8313ed055','7','17','1',6);

insert into DB_PZC.tb_user values('2111','81dc9bdb52d04dc20036dbd8313ed055','1','test','81dc9bdb52d04dc20036dbd8313ed055','7','17','1',2);

insert into DB_PZC.tb_user values('2112','81dc9bdb52d04dc20036dbd8313ed055','1','test','81dc9bdb52d04dc20036dbd8313ed055','7','17','1',2);

insert into DB_PZC.tb_user values('211801001','81dc9bdb52d04dc20036dbd8313ed055','1','邓力文','81dc9bdb52d04dc20036dbd8313ed055','6','14','1',3);
                            
insert into DB_PZC.tb_user values('211801002','81dc9bdb52d04dc20036dbd8313ed055','1','朱明波','81dc9bdb52d04dc20036dbd8313ed055','6','15','2',3);

insert into DB_PZC.tb_user values('211706001','81dc9bdb52d04dc20036dbd8313ed055','1','石利民','81dc9bdb52d04dc20036dbd8313ed055','7','17','2',3);

insert into DB_PZC.tb_user values('211703001','81dc9bdb52d04dc20036dbd8313ed055','2','方海婷','81dc9bdb52d04dc20036dbd8313ed055','9','22','1',3);

insert into DB_PZC.tb_user values('211704001','81dc9bdb52d04dc20036dbd8313ed055','2','王丽芬','81dc9bdb52d04dc20036dbd8313ed055','5','13','1',3);

insert into DB_PZC.tb_user values('211803001','81dc9bdb52d04dc20036dbd8313ed055','2','欧宇锶','81dc9bdb52d04dc20036dbd8313ed055','11','27','1',3);

insert into DB_PZC.tb_user values('211705001','81dc9bdb52d04dc20036dbd8313ed055','2','葛佳凝','81dc9bdb52d04dc20036dbd8313ed055','2','6','1',3);

insert into DB_PZC.tb_user values('211703002','81dc9bdb52d04dc20036dbd8313ed055','2','陈香香','81dc9bdb52d04dc20036dbd8313ed055','9','22','1',3);

insert into DB_PZC.tb_user values('211704002','81dc9bdb52d04dc20036dbd8313ed055','2','李君芮','81dc9bdb52d04dc20036dbd8313ed055','5','13','1',3);

insert into DB_PZC.tb_user values('211807001','81dc9bdb52d04dc20036dbd8313ed055','2','李泓','81dc9bdb52d04dc20036dbd8313ed055','4','11','1',3);

insert into DB_PZC.tb_user values('211808001','81dc9bdb52d04dc20036dbd8313ed055','2','黄寒琪','81dc9bdb52d04dc20036dbd8313ed055','3','7','1',3);

insert into DB_PZC.tb_user values('211705002','81dc9bdb52d04dc20036dbd8313ed055','1','杜超市','81dc9bdb52d04dc20036dbd8313ed055','2','6','1',3);

insert into DB_PZC.tb_user values('211803002','81dc9bdb52d04dc20036dbd8313ed055','2','黄凡','81dc9bdb52d04dc20036dbd8313ed055','9','20','1',3);

insert into DB_PZC.tb_user values('211705003','81dc9bdb52d04dc20036dbd8313ed055','2','徐淑萍','81dc9bdb52d04dc20036dbd8313ed055','2','5','1',3);

 

insert into DB_PZC.tb_information(title,type,author,createOn,content) values
                                    ('我院学子在第九届“新华三杯”全国大学生数字技术大赛全国总决赛中获得佳绩',
                                    '喜讯',
                                    '福州大学至诚学院',
                                    '2019-12-27 00:00:00',
                                    '日前，第九届“新华三杯”全国大学生数字技术大赛全国总决赛于2019年12月13日至15日在浙江经贸职业技术学院举行。
                                    我院参赛学子成绩优异，均获得名次，其中，二等奖1名，三等奖1名(指导老师：计算机工程系计算机业教研室黄巧云)。
                                    大赛点燃校园，技术改变人生。“新华三杯”全国大学生数字技术大赛由紫光旗下的新华三集团和全国高等院校计算机基础教育研究会联合主办，
                                    旨在推动学生、院校、企业三方互动，“以赛促学习、以赛促教学、以赛促就业”，积极探索高科技技术人才培养思路，
                                    丰富多元化人才培养体系，建立良性的就业生态圈。2010年至今，新华三杯大赛已成功举办9届，累计3000多所院校的23000多人参与比赛，
                                    万余名选手脱颖而出，成功就职于新华三集团及其人才联盟企业。');
                                    
insert into DB_PZC.tb_information(title,type,author,createOn,content) values('我院召开元旦期末和寒假期间安全稳定工作会议',
                                    '通知',
                                    '福州大学至诚学院',
                                    '2019-12-24 00:00:00',
...
insert into DB_PZC.tb_organization(organization_name,person_id,person_in_charge,number_of_people,description,isEnroll) values
                                    ('综合办公室',
                                    '211801001',
                                    '综合办公室主任',
                                    '1',
...
insert into DB_PZC.tb_organization(organization_name,person_id,person_in_charge,description,isEnroll) values
                                    ('社团联合会',
                                    '211704001',
                                    '社团联合会主席',
...
insert into DB_PZC.tb_organization(organization_name,person_id,person_in_charge,description) values
                                    ('青年志愿者协会',
                                    '211703002',
                                    '青年志愿者协会会长',
...
insert into DB_PZC.tb_activities(organization_id,activity_name,activity_create_time,activity_start_time,activity_description,activity_state) values
                                    ('13',
...
insert into DB_PZC.tb_activities(organization_id,activity_name,activity_create_time,activity_start_time,activity_description) values
                                    ('10',
...
insert into DB_PZC.tb_activities_enroll(user_id,activity_id,activity_enroll_state) values(
                                    '1234',
                                    '3',
                                    '2');
...
insert into DB_PZC.tb_organization_enroll(user_id,organization_id,organization_enroll_state) values(
                                    '2111',
                                    '1',
                                    '2');
