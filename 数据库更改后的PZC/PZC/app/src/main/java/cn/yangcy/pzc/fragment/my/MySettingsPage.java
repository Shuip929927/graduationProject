    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardUpdatePassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final EditText oldPassword = new EditText(MySettingsPage.this);
                oldPassword.setHint(R.string.et_old_password_hint);
                final EditText newPassword = new EditText(MySettingsPage.this);
                newPassword.setHint(R.string.et_new_password_hint);
                final EditText checkNewPassword = new EditText(MySettingsPage.this);
                checkNewPassword.setHint(R.string.et_check_new_password_hint);
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (oldPassword.getText().toString().isEmpty()
                                    ...
                                    User u = new User(user.getAccount(), MD5Util.digest(newPassword.getText().toString()),
                                            user.getName(),user.getPhoneNumber(),user.getDepartmentId(),
